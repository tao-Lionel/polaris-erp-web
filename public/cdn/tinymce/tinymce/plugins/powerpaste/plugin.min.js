...
!(function (y) {
    ...
    Ee = function (e, t) {
      return (function (e, t) {
        for (var n, r, o = void 0 !== t ? t : xe, i = 0; i < e.length; ++i)
          (n = o), (r = e[i]), (void 0 !== n[r] && null !== n[r]) || (n[r] = {}), (o = n[r]);
        return o;
      })(e.split('.'), t);
    },
    we = {
  ...
  function Oe(e) {
    ...
    if (!n) return _.none();
    for (
      var r = n[1], o = t[1], i = Ce.atob(o), a = i.length, u = Math.ceil(a / 1024), c = new Array(u), s = 0;
      s < u;
      ++s
    ) {
      for (var l = 1024 * s, f = Math.min(l + 1024, a), d = new Array(f - l), m = l, p = 0; m < f; ++p, ++m)
  ...
  var Ue,
    ...
    $t = function (e, t, n) {
      if (!(k(n) || F(n) || U(n)))
        throw (
          (y.console.error('Invalid call to Attr.set. Key ', t, ':: Value ', n, ':: Element ', e),
    ...
    on = {
      ...
      isFiles:
        Zt.browser.isChrome() || Zt.browser.isSafari() || Zt.browser.isOpera()
          ? nn
          : Zt.browser.isFirefox()
          ? tn
          : Zt.browser.isIE()
          ? en
          : rn,
    ...
    cn = {
      fromHtml: function (e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (
            (y.console.error('HTML does not have a single root node', e),
              ...
              return (
                ...
                l(function (e, t) {
                  ...
                  null === n
                    ...
                    : n !== t && ('class' === e ? (o.className = n) : o.setAttribute(e, n), (i[e] = n));
                }),
                (t = u),
                i
              );
      ...
      switch (i.nodeType) {
        case 1:
          e
            ...
            (r =
              'HTML' !== i.scopeName && i.scopeName && i.tagName && i.tagName.indexOf(':') <= 0
        ...
        filterStyles: function (r) {
          if (m() === hn) {
            ...
            dn.each(u, function (e, t) {
              var n = r(t, e);
              null === n
                ? (i.style.removeProperty ? i.style.removeProperty(En(t)) : i.style.removeAttribute(En(t)), delete u[t])
                : ((o += t + ': ' + n + '; '), (u[t] = n));
            }),
              (o = o || null),
              p(function (e, t) {
    ...
    Rn = An(function (e, t) {
      ...
      switch (t.type()) {
        case Cn.TEXT_TYPE:
          ...
          break;
        case Cn.END_ELEMENT_TYPE:
          Mn && ((n = t), Pn.test(n.tag()) || t === Cn.FINISHED)
            ? (e.emit(Cn.createEndElement('P', e.document)), (Mn = !1))
            : 'BR' === t.tag() && e.emit(t);
          break;
        case Cn.START_ELEMENT_TYPE:
          'BR' === t.tag()
            ? (t.filterAttributes(kn), t.filterStyles(kn), e.emit(t))
            : 'IMG' === t.tag() &&
              t.getAttribute('alt') &&
              (r(), e.emit(Cn.createText(t.getAttribute('alt'), e.document)));
      }
    ...
    Wn = An(function (e, t) {
      e.seenList ||
        (e.inferring
          ? 'LI' === t.tag() &&
            (t.type() === Cn.START_ELEMENT_TYPE ? e.inferring++ : (e.inferring--, e.inferring || (e.needsClosing = !0)))
          : ('OL' === t.tag() || 'UL' === t.tag()
              ? (e.seenList = !0)
              : 'LI' === t.tag() &&
                ((e.inferring = 1), e.needsClosing || e.emit(Cn.createStartElement('UL', {}, {}, e.document))),
            !e.needsClosing ||
              e.inferring ||
              t.isWhitespace() ||
              ((e.needsClosing = !1), e.emit(Cn.createEndElement('UL', e.document))))),
        e.emit(t);
    }),
    qn = _n(function (e, t) {
    ...
    Xn = function (e, t) {
      return e.type() === Cn.START_ELEMENT_TYPE
        ? 0 === e.getAttributeCount() ||
            (t && 1 === e.getAttributeCount() && null !== e.getAttribute('style') && void 0 !== e.getAttribute('style'))
        ...
        return (
          ...
          (a = br[r])
            ...
            : (dn.each(hr, function (e) {
              ...
              a &&
                !a.variant &&
                ((i = '(' === r.charAt(0) ? '()' : ')' === r.charAt(r.length - 1) ? ')' : '.'), (a = xr(a, i)))),
    ...
    var i,
      ...
      l = function (e, t) {
        var n = {},
          r = {};
        s++,
          t && e.type && (n = { 'list-style-type': e.type }),
          e.start && 1 < e.start && (r = { start: e.start }),
          o.push(e),
      ...
      m = function (e, t, n) {
        ...
        i &&
          ...
          (f(),
          n &&
            (a.emit(Cn.createStartElement('P', {}, {}, u)),
    ...
    return {
      ...
      openItem: function (e, t, n, r) {
        if (n) {
          for (s || (s = 0); e < s; ) d(), f();
          var o, i;
          if (((i = e), 'UL' === (o = n).tag && Nr[i - 1] === o.type && (o = { tag: 'UL' }), (n = o), s === e))
            d(), m(t, n, r);
          else
            for (
              1 < e &&
              0 < c.length &&
              'P' !== c[c.length - 1] &&
              (a.emit(Cn.createEndElement(c[c.length - 1], u)), (c[c.length - 1] = 'P'));
              s < e;

            )
              l(n, s === e - 1), m(s === e ? t : void 0, n);
        }
      },
  ...
  var Or = function (e, t) {
    ...
    kr = function (e, t, n) {
      n.type() === Cn.END_ELEMENT_TYPE &&
        ...
        ((t.nextFilter = Ar), (t.styleLevelAdjust = -1)),
        e.emit(n);
    },
    Mr = function (e, t, n) {
      if (
        (n.type() === Cn.START_ELEMENT_TYPE && 'Ignore' === n.getStyle('mso-list') && (t.nextFilter = Rr),
        n.type() === Cn.START_ELEMENT_TYPE && 'SPAN' === n.tag())
      )
        t.spanCount.push(n),
          ((t.commentMode && '' === n.getAttribute('style')) || null === n.getAttribute('style')) &&
            (t.nextFilter = Rr);
    ...
    Ur = function (o, i, a) {
      var e = function (e) {
        ...
        if (
          ((i.nextFilter = Br),
          i.commentMode &&
            (i.itemLevel = i.indentGuesser.guessIndentLevel(a, i.originalToken, i.styles.styles, i.bulletInfo)),
          (i.listType = Er.guessListType(
            i.bulletInfo,
          ...
          for (
            i.emitter.openItem(i.itemLevel, i.originalToken, i.listType, i.skippedPara), o.emitDeferred();
          ...
          dn.log('Unknown list type: ' + i.bulletInfo.text + ' Symbol font? ' + i.bulletInfo.symbolFont), o.rollback();
      };
    ...
    Br = function (e, t, n) {
      n.type() === Cn.END_ELEMENT_TYPE && n.tag() === t.originalToken.tag()
        ? ((t.nextFilter = Ar), (t.skippedPara = !1))
        : e.emit(n);
    },
    Yr = { initial: Pr },
    Hr = {},
      ...
      openDialog: function (e, t, n) {
        var r,
          ...
          u = {
            ...
            spacing: 10,
            padding: 10,
            items: [{ type: 'container', html: t('cement.dialog.paste.instructions') }],
            buttons: a,
          };
      ...
      openDialog: function (e, t, n) {
        var r = t('cement.dialog.paste.clean'),
          ...
          i = {
            ...
            body: {
              type: 'panel',
              items: [{ type: 'htmlpanel', name: 'instructions', html: t('cement.dialog.paste.instructions') }],
            },
            buttons: [
  ...
  function Jr(u, e, t, r, c) {
    ...
    u.on('drop', function (e) {
      if (!s) {
        ...
        d((o = r)) ||
          (!f(o, 'text/html') && !f(o, 'text/plain')) ||
          (Zr(u, ln.translate, c).showDialog(r['text/html'] || r['text/plain']), e.preventDefault());
      }
      var o, i, a;
    });
  }
    ...
    qo = function (n, e) {
      ...
      ne(r, function (e, t) {
        k(t) || k(e)
          ...
          : y.console.error('Request header data was not a string: ', t, ' -> ', e);
      });
    },
    $o = function (t) {
          ...
          .map(function (e) {
            var t =
              0 === r.status
                ...
                : 'Could not load url "' + n + '": ' + r.statusText;
        ...
        '' !== o.protocol
          ...
          : ('' !== o.authority
              ...
              : ('' === o.path
                  ...
                  : (Et(o.path, '/')
                      ? (i.path = Ii(o.path))
                      : ((i.path = Si(r.path, o.path, e.authority)), (i.path = Ii(i.path))),
                    (i.query = o.query)),
  ...
  function Ni(d) {
    var e,
      ...
      o = function (e, t, l) {
        ...
        ((n = d.url), (r = s), (o = gi.text()), (i = c), (u = Ho.post()), si(n, u, _.some(r), o, i, a)).map(function (
          e
        ) {
          e.fold(
            function (e) {
      ...
      return v(
        4 === (o = oa.getTinymceVersion()).major() && o.minor() < 6
          ...
          : e +
              '.' +
              ((n = t.toLowerCase()),
              (r = { 'image/jpeg': 'jpg', 'image/jpg': 'jpg', 'image/gif': 'gif', 'image/png': 'png' }).hasOwnProperty(
                n
              )
                ? r[n]
                : 'dat')
  ...
  var Ta = function (t, r, e, n) {
      ...
      getOnKeyDownFunction: function (t, n, r) {
        return function (e) {
          (tinymce.isOpera || 0 < navigator.userAgent.indexOf('Firefox/2')) &&
            (((tinymce.isMac ? e.metaKey : e.ctrlKey) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode)) &&
            Ta(t, n, r, e);
        };
      },
    },
    ...
    Ya = function (e, t, n) {
      if (!k(n))
        throw (
          (y.console.error('Invalid call to CSS.set. Property ', t, ':: Value ', n, ':: Element ', e),
      ...
      vshape: function (e) {
        return Ga(e).map(function (e) {
          ...
          return (
            ...
            Wa(r, { width: qa(e, 'width'), height: qa(e, 'height') }),
            r
          );
        });
      },
    ...
    wu = function (e, t, n) {
      ...
      switch (e.nodeType) {
        case 1:
          t ? (r = Tu) : ((r = xu), Wa(a, n || {})),
            (o =
              'HTML' !== e.scopeName && e.scopeName && e.tagName && e.tagName.indexOf(':') <= 0
  ...
  var nc,
      ...
      return tc(
        ...
        [
          Qu(
            function (e, t) {
              return (
                t.type() === Lu.END_ELEMENT_TYPE && e.originalToken.get() && t.tag() === e.originalToken.get().tag()
              );
            },
            function (e, t, n) {
              Xu(t, r.outside());
    ...
    hc = function (e) {
      var t;
      return e
        ? void 0 !== (t = Yu(e, 'margin-left')) && '0px' !== t
          ? { 'margin-left': t }
          : {}
      ...
      var r,
        ...
        u =
          e.type() && !qu.eqListType(e.type(), n)
            ? ((r = n),
              (o = bc(e)),
              (i = yc(o.state(), r, r.type ? { 'list-style-type': r.type } : {})),
              fc.result(i.state(), o.result().concat(i.result())))
            : fc.result(e, []),
    ...
    rs = function (e) {
      return (
        ...
        (1 === e.dom().attributes.length && 'style' === e.dom().attributes[0].name)
      );
    },
    os = {
  ...
  var as,
    ...
    ws = Pu({
      attributes: [
        { name: tu.exact('id', tu.caseInsensitive), value: tu.starts('docs-internal-guid', tu.caseInsensitive) },
      ],
    }),
    Is = [Ru([ts.filter])],
    Ss = Pu({
    ...
    Ls = Pu({
      tags: [
        ...
        { name: tu.exact('style', tu.caseInsensitive), condition: os.isEmpty },
      ],
      attributes: [
    ...
    Ms = Pu({
      attributes: [{ name: tu.exact('style', tu.caseInsensitive), value: tu.exact('', tu.caseInsensitive), debug: !0 }],
    }),
    Rs = Pu({
      attributes: [{ name: tu.exact('class', tu.caseInsensitive), value: tu.exact('', tu.caseInsensitive), debug: !0 }],
    }),
    Fs = ku({
      tags: [
        {
    ...
    qs = {
      ...
      removeLocalLinks: Pu({
        attributes: [
          { name: tu.exact('href', tu.caseInsensitive), value: tu.starts('file:///', tu.caseInsensitive), debug: !0 },
        ],
      }),
      ...
      removeFragmentComments: function (a) {
        ...
        t.each(function (i) {
          n.each(function (e) {
            for (
              var t, n = i, r = [], o = ((t = bs(i, 0, e, 0)), cn.fromDom(t.commonAncestorContainer));
              void 0 !== o && !Io(o, a);

            )
              Y(u, Ut(o)) ? (n = o) : r.push(o), (o = Co(o).getOr(void 0));
            q(r, ja), q(Ao(n), Fa);
          }),
            Fa(i);
        }),
    ...
    nl =
      (Qr('word', 'pattern'), Qr('element', 'offset'), Qr('element', 'deltaOffset'), Qr('element', 'start', 'finish')),
    rl =
      (Qr('begin', 'end'),
      Qr('element', 'text'),
      ue([{ include: ['item'] }, { excludeWith: ['item'] }, { excludeWithout: ['item'] }])),
    ol = {
      include: rl.include,
        ...
        le(n, {
          ...
          match: function (t, n) {
            ...
            return Pa(r, function (e) {
              ...
              'Must find branch for constructor: ' +
                (0 === (e = t._simpleAdt).indexOf(Al) ? e.substring(Al.length + '_'.length) : e)
            )(t.data);
          },
        })
      );
    ...
    Yl = function (e) {
      return (
        xt(e, '<html') &&
        (xt(e, 'xmlns:o="urn:schemas-microsoft-com:office:office"') ||
          xt(e, 'xmlns:x="urn:schemas-microsoft-com:office:excel"'))
      );
    },
    Hl = function (e) {
  ...
  var jf = function (e, t) {
    ...
    Hf = function (e, t, n, r, o, i) {
      return -1 === e || -1 === t
        ? _.none()
        : _.some({ start: e, end: t, bower: n, regex: r, idRef: o, isEquation: i });
    },
    Wf = function (e, t, n) {
    ...
    qf = function (e, t) {
      ...
      do {
        if (
          ((n = e.indexOf('{', t)) < (r = e.indexOf('}', t)) && -1 !== n
            ? ((t = n + 1), ++o)
            : (r < n || n < 0) && -1 !== r && ((t = r + 1), --o),
          i < t || -1 === r)
        )
    ...
    zf = function (e) {
      return 0 <= e.indexOf('\\pngblip')
        ...
        ? Go.value('image/jpeg')
        : Go.error('errors.imageimport.unsupported');
    },
    Kf = function (e, t) {
      var n = e.match(t);
            ...
            return (
              ...
              'unsupported' === n
                ...
                : X(i, function (e) {
                    ...
                    function () {
                      return (
                        y.console.log('WARNING: unable to find data for image ', t.dom()),
                        (u = !0),
  ...
  var dd,
        ...
        if (m(e)) {
          var t,
            ...
            d =
              ...
              (a = f),
              (u = e),
              { target: v(t), x: v(n), y: v(r), stop: o, prevent: i, kill: a, raw: v(u) });
          p(d);
        }
      };
    },
    bd = function (e, t, n, r) {
      return (
        (o = e), (i = t), (a = !1), (u = yd(n, r)), o.dom().addEventListener(i, u, a), { unbind: N(xd, o, i, u, a) }
      );
      var o, i, a, u;
    },
    xd = function (e, t, n, r) {
                    ...
                    return (
                        ...
                        if (e.test(s))
                          for (r = 0, o = (n = s.match(e)).length; r < o; r += 1)
                            (l[t] += 1),
                              ...
                              (a = s.indexOf(i)),
                              (u = i.length),
                              f.push({ selector: c.substr(a, u), type: t, index: a, length: u }),
                              (s = s.replace(i, Array(u + 1).join(' ')));
                      }),
                      (t = function (e) {
                        var t, n, r, o;
                        if (e.test(s))
                          for (n = 0, r = (t = s.match(e)).length; n < r; n += 1)
                            (o = t[n]), (s = s.replace(o, Array(o.length + 1).join('A')));
                      })(/\\[0-9A-Fa-f]{6}\s?/g),
                      t(/\\[0-9A-Fa-f]{1,5}\s/g),
                      t(/\\./g),
                      ...
                      (function () {
                        var e,
                          ...
                          o = /{[^]*/gm;
                        if (o.test(s))
                          for (t = 0, n = (e = s.match(o)).length; t < n; t += 1)
                            (r = e[t]), (s = s.replace(r, Array(r.length + 1).join(' ')));
                      })(),
                      e(/(\[[^\]]+\])/g, 'b'),
                      e(/(#[^\#\s\+>~\.\[:]+)/g, 'a'),
                      e(/(\.[^\s\+>~\.\[:]+)/g, 'b'),
      ...
      var f = function (n) {
          Kt(n, 'data-list-level'),
            ...
            ne(
              ...
              function (e, t) {
                !t.startsWith('border') ||
                  ('border-image' !== t && 'none' !== e.trim() && 'initial' !== e.trim()) ||
                  Xa(n, t);
              }
            );
        },
      ...
      if (
        ...
        q(n, function (e) {
          var t,
            ...
            c =
              ((i = u), (a = zt((o = l), 'data-tab-interval') ? Gt(o, 'data-tab-interval') : '36pt'), i.convertToPx(a)),
            s = Yd(e, c, u).getOr({});
    ...
    rm = function (e) {
      ...
      return _a.sync(function (e) {
        var t,
          ...
          i =
            0 < a.text().length
              ? ((t = a.text()), (n = tm(t)), (r = nm(n)), (o = aa(r)), Na.paste(o, []))
              : Na.cancel();
      ...
      return _a.sync(function (u) {
        ...
        e.events.after.bind(function (e) {
          ...
          if (bm.browser.isSafari() && Vi(t, 'img[src^="webkit-fake-url"]').isSome()) {
            ...
            _a.call(u, {
              response: s,
              bundle: Sa.nu({ isWord: r, isGoogleDocs: a, isInternal: i, proxyBin: t, backgroundAssets: c }),
            });
          }
        }),
          c.convert(n),
    ...
    Dm = {
      ...
      googledocs: function (e, t, n) {
        return Nm(
          ' pasting',
          Cm,
          [Df(dm({ officeStyles: !1, htmlStyles: !1 })), Df(sm(t, n)), Df(Ff(e)), Df(Cf())],
          !0
        );
      },
      image: function (e) {
      ...
      nativeHtml: function (e, t, n, r) {
        return Nm(
          ...
          Im,
          [Df(cm(t.intraFlag)), Df(hd(e, t)), Df(sm(n, r)), Df(Ff(t)), Df(Cf())],
          !0
        );
      },
      text: function () {
      ...
      fallback: function (e, t, n, r, o, i) {
        return Nm(
          ...
          Em,
          [Df(xm(r, n, o, t.intraFlag, Af)), Df(hd(e, t)), Df(lm(o, t.intraFlag)), Nf(id(i, t)), Df(Ff(t)), Df(Cf())],
          !1
        );
      },
    },
            ...
            var o = t,
              i = y.setInterval(function () {
                n()
                  ? y.clearInterval(i)
                  : o <= 0
                  ? (u.trigger.timeout(), y.clearInterval(i))
                  : r() && (y.clearInterval(i), u.trigger.crashed()),
                  o--;
              }, e);
            a.set(_.some(i));
          },
          ...
          var i = function () {
            ...
            l = (function () {
              var e = r.replace(/^https?:\/\//, '//'),
                t =
                  '    <param name="allowscriptaccess" value="always">    <param name="wmode" value="opaque">    <param name="FlashVars" value="onLoad=' +
                  a +
                  '">';
  ...
  var Xm,
    ...
    Zm = function (e, t) {
      ...
      return (
        Xt(a, { rel: 'stylesheet', type: 'text/css', href: e }),
        (n = i),
        (r = a),
  ...
  var xp = 'powerpaste-styles',
    ...
    Cp = function (e, t, n) {
      ...
      try {
        return (
          e.clearData(), e.setData('text/html', t), e.setData('text/plain', n), e.setData(Sp.internalHtmlMime(), t), !0
        );
      } catch (e) {
        return !1;
      }
    ...
    Dp = function (a) {
      return function (e, t) {
        ...
        a.dom.setStyles(n, { position: 'fixed', top: '50%', left: '-3000px', width: '1000px', overflow: 'hidden' }),
          n.appendChild(r),
    ...
    $p = {
      process: function (e, t, n) {
        ...
        return (
          (d = v),
          (m = n),
          (o = Wp((f = r = e), 'PastePreProcess')
            ? ((p = d), (g = m), f.fire('PastePreProcess', { internal: g, content: p }).content)
            : d),
          (i = n),
          Wp(r, 'PastePostProcess')
            ? ((u = o),
              (c = i),
              (s = (a = r).dom.add(a.getBody(), 'div', { style: 'display:none' }, u)),
              (l = a.fire('PastePostProcess', { internal: c, node: s }).node.innerHTML),
              a.dom.remove(s),
              l)
            : o
        );
    ...
    v.on('init', function (e) {
      ...
      var s,
        ...
        m =
          ...
          Ef(
            [Dm.onlyText(), Dm.wordimport(i, n, o, u), Dm.googledocs(o, r, t), Dm.nativeHtml(n, o, r, t), Dm.image(o)],
            Dm.fallback(n, o, r, c, t, u)
          )),
      ...
      q([m, p], function (e) {
          ...
          e.events.error.bind(function (e) {
            L(),
              v.notificationManager
                ? v.notificationManager.open({ text: ln.translate(e.message()), type: 'error' })
        ...
        v.addCommand('mceInsertClipboardContent', function (e, t) {
          void 0 !== t.content
            ? m.pasteCustom(zl.fromHtml(t.content))
            : void 0 !== t.text && p.pasteCustom(zl.fromText(t.text));
        });
          ...
          var t,
            ...
            o = (function (t, n) {
              ...
              t.on('keydown', function (e) {
                Xp(e) &&
                  (o.set(!0), tinymce.Env.ie && tinymce.Env.ie < 10 && (e.preventDefault(), t.fire('paste', {})));
              });
              var i = function () {
                var e = !r.get();
