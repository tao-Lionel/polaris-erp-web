...
export function getPageList(data) {
  return request({
    url: "/dataanalysis/daSalesForecast/pageList",
    method: "post",
    data
  })
}
...
export function getCheckDetailList(data) {
  return request({
    url: "/dataanalysis/daSalesForecast/showList",
    method: "post",
    data
  })
}
...
export function getUnLock(data) {
  return request({
    url: "/dataanalysis/daSalesForecast/unLock",
    method: "post",
    data
  })
}
...
export function getLock(data) {
  return request({
    url: "/dataanalysis/daSalesForecast/lock",
    method: "post",
    data
  })
}
...
export function exportData(obj) {
  return request({
    url: "/dataanalysis/daSalesForecast/exportData",
    method: "post",
    responseType: "blob",
    data: obj
  })
...
export function deleteForecastApi(data) {
  return request({
    url: "/dataanalysis/daSalesForecast/delete",
    method: "post",
    data
  })
}
