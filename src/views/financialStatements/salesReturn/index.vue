...
import { salesReturnOption } from "@/const/crud/financialStatements/index"
...
import { getList } from "@/api/financialStatements/psiStatements/salesReturn"
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      salesReturnOption: salesReturnOption,
      page: {
        total: 0, // 总页数
        currentPage: 1, // 当前页数
        pageSize: 20 // 每页显示多少条
