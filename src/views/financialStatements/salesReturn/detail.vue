        ...
        <el-form label-width="80px" :model="detailForm" ref="detailForm">
          <detail-wrapper :options="{ title: '基本信息' }">
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="客户" prop="fRetcustName">
                  <el-input
                    class="el-input--small"
                    v-model="detailForm.fRetcustName"
                    placeholder="暂无数据"
                    size="mini"
                    disabled
                  ></el-input>
              ...
              <el-col :span="8">
                <el-form-item label="退货日期" prop="fDate">
                  <el-input
                    class="el-input--small"
              ...
              <el-col :span="8">
                <el-form-item label="来源" prop="source">
                  <div style="display: flex">
                    ...
                    <router-link
                      v-if="detailForm.sourceType === 'SALE_RETURN'"
                      style="margin-left: 20px; width: 50px"
                      :to="{ path: '/order/orderManages/detail', query: { id: detailForm.sourceId } }"
                      >查看</router-link
                    >
                    <router-link
                      v-if="detailForm.sourceType === 'INNER_SALE_RETURN'"
                      style="margin-left: 20px; width: 50px"
                      :to="{
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="出库单号" prop="outStockId">
                  <div style="display: flex">
                    <span>{{ detailForm.outStockId }}</span>
                    <router-link
                      v-if="detailForm.sourceType === 'SALE'"
                      style="margin-left: 20px; width: 50px"
                      :to="{ path: '/order/orderManages/detail', query: { id: detailForm.outStockId } }"
                      >查看</router-link
                    >
                  </div>
                </el-form-item>
      ...
      <div>
        <detail-wrapper :options="{ title: '费用明细' }">
          <div style="padding: 10px">
            ...
            <avue-crud ref="addSkuCrud" :data="detailList" :option="salesReturnDetailOption">
...
import { salesReturnDetailOption, logOption } from "@/const/crud/financialStatements/index"
import { getDetail } from "@/api/financialStatements/psiStatements/salesReturn"
...
export default {
  ...
  data() {
    return {
      ...
      auditStatus: [],
      syncStatus: [],
      salesReturnDetailOption: salesReturnDetailOption,
      logOption: logOption,
      logData: [],
      activeName: "first",
      searchForm: {
