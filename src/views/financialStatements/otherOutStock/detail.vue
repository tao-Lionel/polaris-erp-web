        ...
        <el-form label-width="80px" :model="detailForm" ref="detailForm">
          <detail-wrapper :options="{ title: '基本信息' }">
            ...
            <el-row>
                ...
                <el-form-item label="来源" prop="source">
                  <div style="display: flex">
                    ...
                    <router-link
                      ...
                      :to="{ path: '/otherOutStock/create', query: { orderNo: detailForm.sourceNo } }"
                      >查看</router-link
                    >
                  </div>
                </el-form-item>
              ...
              <el-col :span="8">
                <el-form-item label="出库用途" prop="fOraCkytName">
                  <el-input
                    class="el-input--small"
                    v-model="detailForm.fOraCkytName"
                    placeholder="暂无数据"
                    size="mini"
                    disabled
                  ></el-input>
      ...
      <div>
        <detail-wrapper :options="{ title: '费用明细' }">
          <div style="padding: 10px">
            ...
            <avue-crud ref="addSkuCrud" :data="detailList" :option="otherOutStockDetailOption"> </avue-crud>
          </div>
        </detail-wrapper>
      </div>
    </basic-container>
...
import { otherOutStockDetailOption, logOption } from "@/const/crud/financialStatements/index"
import { getDetail } from "@/api/financialStatements/psiStatements/otherOutStock"
