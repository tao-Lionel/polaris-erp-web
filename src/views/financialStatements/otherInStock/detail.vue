      ...
      <div>
        <el-form label-width="80px" :model="detailForm" ref="detailForm">
          <detail-wrapper :options="{ title: '基本信息' }">
            <el-row>
              <el-col :span="8">
                <el-form-item label="入库单号" prop="fBillNo">
                  <el-input
              ...
              <el-col :span="8">
                <el-form-item label="库存组织" prop="fStockOrgName">
                  <el-input
                    class="el-input--small"
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="来源" prop="source">
                  <div style="display: flex">
                    ...
                    <router-link
                      v-if="detailForm.sourceType === 'OTHER'"
                      style="margin-left: 20px; width: 50px"
                      :to="{ path: '/otherInStock/create', query: { orderNo: detailForm.sourceNo } }"
                      >查看</router-link
                    >
                  </div>
                </el-form-item>
              ...
              <el-col :span="8">
                <el-form-item label="入库用途" prop="fOraRkytName">
                  <el-input
                    class="el-input--small"
                    v-model="detailForm.fOraRkytName"
                    placeholder="暂无数据"
                    size="mini"
                    disabled
                  ></el-input>
      ...
      <div>
        <detail-wrapper :options="{ title: '费用明细' }">
          <div style="padding: 10px">
            ...
            <avue-crud ref="addSkuCrud" :data="detailList" :option="otherInStockDetailOption"> </avue-crud>
          </div>
        </detail-wrapper>
      </div>
    </basic-container>
...
import { otherInStockDetailOption, logOption } from "@/const/crud/financialStatements/index"
import { getDetail } from "@/api/financialStatements/psiStatements/otherInStock"
