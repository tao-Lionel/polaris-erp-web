    ...
    <basic-container>
      ...
      >
        ...
        <template slot-scope="scope" slot="fBillNo">
          <router-link
            :to="{ path: '/financialStatements/psi/otherInStockDetail/detail', query: { fBillNo: scope.row.fBillNo } }"
...
import { otherInStockOption } from "@/const/crud/financialStatements/index"
...
import { getList } from "@/api/financialStatements/psiStatements/otherInStock"
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      otherInStockOption: otherInStockOption,
      page: {
        total: 0, // 总页数
        currentPage: 1, // 当前页数
        pageSize: 20 // 每页显示多少条
...
<style lang="scss">
#otherInStock > .basic-container > .el-card > .el-card__body {
  padding: 5px 20px;
}
</style>
