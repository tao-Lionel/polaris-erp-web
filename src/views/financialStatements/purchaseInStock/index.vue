      ...
      >
        <template slot="search">
          <el-form :model="searchForm" ref="searchForm" :inline="true">
            ...
            <el-form-item prop="fPurchaseOrgId" label="">
              <el-select v-model="searchForm.fPurchaseOrgId" size="small" placeholder="采购组织" clearable>
                <el-option
        ...
        <template slot-scope="scope" slot="fBillNo">
          <router-link
            :to="{
              path: '/financialStatements/psi/purchaseInStockDetail/detail',
...
import { purchaseInStockOption } from "@/const/crud/financialStatements/index"
...
import { getList } from "@/api/financialStatements/psiStatements/purchaseInStock"
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      purchaseInStockOption: purchaseInStockOption,
      page: {
        total: 0, // 总页数
        currentPage: 1, // 当前页数
        pageSize: 20 // 每页显示多少条
