      ...
      <div>
        <el-form label-width="90px" :model="detailForm" ref="detailForm">
          <detail-wrapper :options="{ title: '基本信息' }">
            <el-row>
              <el-col :span="8">
                <el-form-item label="退货单号" prop="fBillNo">
                  <el-input
              ...
              <el-col :span="8">
                <el-form-item label="供应商" prop="fSupplierName">
                  <el-input
                    class="el-input--small"
                    v-model="detailForm.fSupplierName"
                    placeholder="暂无数据"
                    size="mini"
                    disabled
                  ></el-input>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="采购单" prop="currency" label-width="95px">
                  <div style="display: flex">
                    <span style="margin-left: 10px">{{ detailForm.sourcePurchaseNo }}</span>
                    <router-link
                      style="margin-left: 20px; width: 50px"
                      :to="{
                        path: '/orderUpdate/index',
                        query: { purchaseOrderNo: detailForm.sourcePurchaseNo }
                      }"
                      >查看</router-link
                    >
                  </div>
              ...
              <el-col :span="8">
                <el-form-item label="退货组织" prop="fStockOrgName">
                  <el-input
                    class="el-input--small"
                    v-model="detailForm.fStockOrgName"
                    placeholder="暂无数据"
                    size="mini"
                    disabled
                  ></el-input>
              ...
              <el-col :span="8">
                <el-form-item label="退货日期" prop="fDate" label-width="95px">
                  <el-input
                    class="el-input--small"
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="来源" prop="source">
                  <div style="display: flex">
                    ...
                    <router-link
                      v-if="detailForm.sourceType === 'PURCHASE_RETURN'"
                      style="margin-left: 20px; width: 50px"
                      :to="{ path: '/poreturn/detail', query: { returnNo: detailForm.sourceNo } }"
                      >查看</router-link
                    >
                    <router-link
                      v-if="detailForm.sourceType === 'INNER_PURCHASE_RETURN'"
                      style="margin-left: 20px; width: 50px"
                      :to="{
              ...
              <el-col :span="8">
                <el-form-item label="退货原因" prop="fMrReason">
                  <el-input
                    class="el-input--small"
                    v-model="detailForm.fMrReason"
                    placeholder="暂无数据"
                    size="mini"
                    disabled
                  ></el-input>
      ...
      <div>
        <detail-wrapper :options="{ title: '费用明细' }">
          <div style="padding: 10px">
            ...
            <avue-crud ref="addSkuCrud" :data="detailList" :option="purchaseReturnDetailOption">
...
import { purchaseReturnDetailOption, logOption } from "@/const/crud/financialStatements/index"
import { fetchTreeList } from "@/api/product/prdskucategory"
import { getDetail } from "@/api/financialStatements/psiStatements/purchaseReturn"
