<template>
  <el-dialog title="删除销量预测" :visible.sync="showLockingDialog" width="500px" center>
    ...
    <el-form ref="form" :model="form" :rules="rules">
      <el-form-item label="删除销量预测的月份" prop="date">
...
import { deleteForecastApi } from "@/api/dataAnalysis/salesForecastPlan"
    ...
    submitForm() {
      this.$refs.form.validate(async (valid) => {
        if (valid) {
          ...
          await deleteForecastApi({ ids, unlockDates: this.form.date, queryPageDto })
