<template>
  <div class="execution" id="amazonVCReport">
    <basic-container>
      <avue-crud
        ref="crud"
        :page="page"
...
<script>
import { getAmazonVCReport, getBatAmazonVCReport, exportAmazonVCReport } from "@/api/report/prdsalegrossprofitReport.js"
...
import { tableOption } from "@/const/crud/report/prdsalegrossprofitReport/amazonVCReport.js"
...
export default {
  ...
  methods: {
    ...
    async exportReport() {
      let res = await exportAmazonVCReport(this.searchFormConfirm)
