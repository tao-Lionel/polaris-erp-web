    ...
    <basic-container>
      ...
      <div class="error-box">
        ...
        <span class="error-text"
          >/404当访问的页面不存在时会跳转到404页面，您可以在浏览器地址栏中修改url为一个不存在的路径，体验一下效果</span
        >
      </div>
    </basic-container>
    <basic-container>
      ...
      <div class="error-box">
        ...
        <span class="error-text"
          >/403在当前登录用户不具有执行当前操作的权限时跳转到该页面，您可以在ajax请求方法中判断返回的状态码为403时跳转到该页面</span
        >
      </div>
    </basic-container>
    <basic-container>
      ...
      <div class="error-box">
        ...
        <span class="error-text"
          >/500当请求之后出现服务端错误时跳转到该页面，您可以在ajax请求方法中判断返回的状态码为500时跳转到该页面</span
        >
      </div>
    </basic-container>
  </div>
