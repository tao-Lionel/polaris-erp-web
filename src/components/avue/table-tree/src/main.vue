  ...
  >
    ...
    >
      <template slot-scope="scope">
        ...
        <span class="tree-ctrl" v-if="iconShow(index, scope.row)" @click="toggleExpanded(scope.$index, scope.row.id)">
          <i v-if="!scope.row._expanded" class="el-icon-plus"></i>
          <i v-else class="el-icon-minus"></i>
        </span>
...
export default create({
  ...
  methods: {
    ...
    // 切换下级是否展开
    toggleExpanded: function (trIndex, id) {
