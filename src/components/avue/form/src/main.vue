<template>
  <div :class="b()" :style="{ width: setPx(tableOption.formWidth, '100%') }">
    <el-form
      ...
      status-icon
      :model="form"
      :inline="tableOption.formIsInline"
      :label-position="tableOption.labelPosition"
      :size="controlSize"
      :label-width="setPx(tableOption.labelWidth)"
      :rules="formRules"
    >
      <el-row :gutter="20" :span="24">
        <!-- :options="dragOptions" -->
        <draggable :list="columnOption" v-bind="dragOptions" :class="b('group')">
          <template v-if="vaildVisdiplay(column)" v-for="(column, index) in columnOption">
            ...
            >
              ...
              <el-form-item
                :label="column.label"
                :prop="column.prop"
                :label-width="setPx(column.labelWidth, tableOption.labelWidth)"
              >
                <el-tooltip :disabled="!column.tip" :content="column.tip" :placement="column.tipPlacement">
                  <slot
