...
export default [
  ...
  {
    path: "/baseSetup/ruleEngineConfig/rulesList",
    component: Layout,
    children: [
      {
        path: "addRule",
        ...
        meta: {
          keepAlive: true,
          parentPath: "/baseSetup/ruleEngineConfig/rulesList/index"
        }
      }
    ]
  },
  ...
  {
    path: "/order/batchInvoiceManage",
    component: Layout,
    children: [
      {
        path: "detail",
        name: "发货批次单详情",
        component: () => import(/* webpackChunkName: "page" */ "@/views/order/batchInvoiceManage/detail"),
        meta: {
          keepAlive: true,
          parentPath: "/order/batchInvoiceManage"
        }
      }
    ]
  },
  ...
  {
    path: "/productCosting/newProductCalc",
    component: Layout,
    children: [
      {
        path: "detail",
        name: "新品试算详情",
        component: () => import(/* webpackChunkName: "page" */ "@/views/productCosting/newProductCalc/detail.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/productCosting/newProductCalc"
        }
      }
    ]
  },
    ...
    children: [
      {
        path: "edit",
        name: "新品试算编辑",
        component: () => import(/* webpackChunkName: "page" */ "@/views/productCosting/newProductCalc/edit.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/productCosting/newProductCalc"
        }
  ...
  {
    path: "/purchase/procurementPlan",
    component: Layout,
    children: [
      {
        path: "create",
        name: "新增采购计划",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/procurementPlan/create.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/procurementPlan"
        }
      }
    ]
  },
    ...
    children: [
      {
        path: "edit",
        name: "编辑采购计划",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/procurementPlan/edit.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/procurementPlan"
        }
    ...
    children: [
      {
        path: "detail",
        name: "采购计划单详情",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/procurementPlan/detail.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/procurementPlan"
        }
  ...
  {
    path: "/purchase/poorder",
    component: Layout,
    children: [
      {
        path: "create",
        name: "新增采购订单",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/poorder/create.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/poorder"
        }
    ...
    children: [
      {
        path: "edit",
        name: "编辑采购订单",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/poorder/edit.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/poorder"
        }
    ...
    children: [
      {
        path: "detail",
        name: "采购订单详情",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/poorder/detail.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/poorder"
        }
    ...
    children: [
      {
        path: "split",
        name: "拆分采购订单",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/poorder/split.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/poorder"
        }
  ...
  {
    path: "/purchase/containerLoadingPlan",
    component: Layout,
    children: [
      {
        path: "generate",
        name: "生成排柜计划",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/containerLoadingPlan/generate.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/containerLoadingPlan"
        }
      }
    ]
  },
    ...
    children: [
      {
        path: "details",
        name: "排柜详情",
        component: () => import(/* webpackChunkName: "page" */ "@/views/purchase/containerLoadingPlan/details.vue"),
        meta: {
          keepAlive: true,
          parentPath: "/purchase/containerLoadingPlan"
        }
...
// Vue,vue-VueRouter,  \@/views/activiti/detail.vue
